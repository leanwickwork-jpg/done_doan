...
import vn.tuananh.jobhunter.domain.request.ReqChangePasswordDTO;
import vn.tuananh.jobhunter.domain.request.ReqLoginDTO;
import vn.tuananh.jobhunter.domain.response.ResCreateUserDTO;
import vn.tuananh.jobhunter.domain.response.ResLoginDTO;
import vn.tuananh.jobhunter.domain.response.ResUpdateUserDTO;
import vn.tuananh.jobhunter.service.UserService;
import vn.tuananh.jobhunter.service.EmailVerificationService;
import vn.tuananh.jobhunter.service.RoleService;
import vn.tuananh.jobhunter.domain.request.ReqVerifyCode;
...
import vn.tuananh.jobhunter.util.error.EmailVerificationException;
...
public class AuthController {
    ...
    @Value("${tuananh.jwt.refresh-token-validity-in-seconds}")
