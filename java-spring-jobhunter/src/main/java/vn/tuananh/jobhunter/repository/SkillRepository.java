...
import vn.tuananh.jobhunter.domain.response.StatisticsDTO.SkillCount;
...
public interface SkillRepository extends JpaRepository<Skill, Long>,
        ...
        @Query(value = "SELECT new vn.tuananh.jobhunter.domain.response.StatisticsDTO$SkillCount(s.name, COUNT(s), 0) " +
               "FROM Skill s " +
               "JOIN s.jobs j " +
               "GROUP BY s.name " +
