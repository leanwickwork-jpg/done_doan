...
import vn.tuananh.jobhunter.domain.Subscriber;
import vn.tuananh.jobhunter.domain.Post;
import vn.tuananh.jobhunter.domain.response.email.ResEmailJob;
import vn.tuananh.jobhunter.repository.JobRepository;
import vn.tuananh.jobhunter.repository.SkillRepository;
import vn.tuananh.jobhunter.repository.SubscriberRepository;
