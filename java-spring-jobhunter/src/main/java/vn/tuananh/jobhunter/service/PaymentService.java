...
import vn.tuananh.jobhunter.domain.request.ReqDepositDTO;
...
public class PaymentService {
    ...
    @Value("${tuananh.vnpay.tmn-code}")
    private String vnp_TmnCode;

    @Value("${tuananh.vnpay.hash-secret}")
    private String secretKey;

    @Value("${tuananh.vnpay.vnp-return-url}")
    private String vnp_ReturnUrl;

    @Value("${tuananh.vnpay.vnp-url}")
